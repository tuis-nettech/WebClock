...
window.onload = function(){
  document.getElementById("setButton0").onclick = function(){
    document.getElementById("cssMain").href = "day.css";
  };
  document.getElementById("setButton1").onclick = function(){
    document.getElementById("cssMain").href = "darkmode.css";
  };
  document.getElementById("setButton2").onclick = function(){
    document.getElementById("cssMain").href = "midnight.css";
  };
};
